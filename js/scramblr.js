...
(function(global, $){//iife
  ...
  Scramblr.prototype = {//Packing the object full of goodies
    ...
    unscramble: function(selector,alg){//function for unscrambling words, try doing algorithms here.
      ...
      //except as a method for testing the speed of different algorithms.

      //Unscrambling without knowing the source string is certainly a good machine learning challenge, as efficiency would demand that the system learn in some way to anticipate patterns.
